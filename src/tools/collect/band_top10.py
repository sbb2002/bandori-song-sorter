...
src/content/songs/*.yaml 의 재생가능 트랙 video_id 를 YouTube Data API(videos.list, part=statistics)
...
대상: 곡 10개 이상인 10개 밴드. various_artists/ikka_dumb_rock/millsage 제외.
  python src/tools/collect/band_top10.py             # 조회수 조회 + TOP10 출력 + 템플릿 생성
  python src/tools/collect/band_top10.py --no-write  # 템플릿 미생성(콘솔만)
"""
import sys
