...
설계 출처: docs/working/spec/audio-map-axes.md
...
사용:
    python src/tools/cluster/perceptual_features.py --pilot          # 워크시트 30곡
    python src/tools/cluster/perceptual_features.py --pilot --no-download   # 캐시만
"""
...
def _ffmpeg_location() -> list[str]:
    ...
    bindir = Path("src/content/cluster/_ffbin")
