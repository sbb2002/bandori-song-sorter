"""src/content/cluster/songs_top10.csv → 밴드 음원 지도 (cluster/audio_map.json).
...
사용:
    ...
    python src/tools/cluster/build_audio_map.py            # backend=librosa(기본)
    python src/tools/cluster/build_audio_map.py --no-download   # 캐시만 사용
"""
