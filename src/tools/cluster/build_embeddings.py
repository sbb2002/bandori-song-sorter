...
사용:
    ...
    python src/tools/cluster/build_embeddings.py
    python src/tools/cluster/build_embeddings.py --model distiluse-base-multilingual-cased-v2
"""
...
WC_DIR = "src/content/wordcloud"
SENTI_PATH = "tools/wordcloud/senti_lexicon.yaml"
OUT_PATH = "src/content/cluster/keywords_2d.json"
