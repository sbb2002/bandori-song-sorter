...
docs/working/report/genre-features/pulse-shapes-demo.html 및 memory pulse_signature_shapes 참고.
...
DEFAULT_FEATURES = ROOT / "docs" / "working" / "report" / "genre-features" / "song_features_with_proxies.csv"
