...
> 선행: [cluster-map-extraction.md](cluster-map-extraction.md) · [B0 스크리닝](../../side-project/emoi-map-emotion-axes/phase-b0/README.md)
...
찍음)로 진단됐다. [Phase B0](../../side-project/emoi-map-emotion-axes/phase-b0/README.md)에서 onset 파생 feature로 arousal을
...
- 비용: 곡당 ~4.4s(테스트 30곡 2분13초). 진행률/pause/resume 인프라 = [B0](../../side-project/emoi-map-emotion-axes/phase-b0/README.md) 계승.

## 3. 결과

![스크리닝 요약](../../side-project/emoi-map-emotion-axes/phase-c/phasec_screening.png)
...
## 4. 해석 — "실질 1.x차원"의 확증
[cluster-correlation](../../side-project/emoi-map-axis-correlation/README.md)에서 제기된 **실질 1.x차원**(contrast가 여러
...
- `side-project/emoi-map-emotion-axes/phase-c/phasec_features.csv`(라벨 30곡 정식 feature 18열) — **커밋 보존**, 재사용.
