...
> 작성 2026-07-07 · 근거: [research](../research/cluster-map-extraction.md) · [report](../../side-project/emoi-map-axis-correlation/cluster_experiment.md) · cluster-correlation
...
- 분포 점검(원 질문): 전곡 히스토그램(라우드니스 평준화로 E1이 뭉치는지 여기서 판명) + 밴드 간/내 분산비 + Millsage·Ikka 스팟 체크. **신호가 나오면 report 전환**(Exp 7, `side-project/emoi-map-emotion-axes/phase-b0/`).
...
| `side-project/emoi-map-emotion-axes/phase-b0/README.md` | 연구 report(신호 시 idea→report 전환) | B0·C | — |
