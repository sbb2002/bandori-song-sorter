...
사용:
    ...
    python tools/wordcloud/build_keywords.py --debug    # yaml 미기록, 상위 명사만 출력
    python tools/wordcloud/build_keywords.py --no-translate   # 기계번역 보완 끔
    python tools/wordcloud/build_keywords.py --band afterglow # 특정 밴드만
"""
